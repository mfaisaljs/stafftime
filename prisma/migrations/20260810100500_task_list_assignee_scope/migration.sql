...
INSERT INTO "new_TaskList" ("id", "shopId", "name", "description", "assignStaff", "assignManagers", "staffScope", "managerScope", "employeeIds", "managerIds", "locationAccess", "locationIds", "timelines", "createdAt", "updatedAt")
SELECT "id", "shopId", "name", "description", "assignStaff", "assignManagers", 'ALL', 'ALL', "employeeIds", '[]', "locationAccess", "locationIds", "timelines", "createdAt", "updatedAt" FROM "TaskList";
DROP TABLE "TaskList";
